...
\textbf {User Stories:}
\newline
As a cane user, I want to get help with objects at body and head level as well so that I won't bump into a pole - Kürşat Ceylan
\newline
As a cane user, I want its symbolic function so people in busy environments such as airports will be more careful - Are electronic white canes better than traditional canes?
\newline
As a cane user, I want to detect objects far away so I wouldn't be vulnerable to overhangs, such as tree branches.I also want to detect objects under feet to help with drop-offs, like curbs and steps
\newline
As a cane user, I want object recognition so I can get around certain people, or find certain objects.I want the cane to be lighter and more delicate so I can receive more information - Daniel Kish
